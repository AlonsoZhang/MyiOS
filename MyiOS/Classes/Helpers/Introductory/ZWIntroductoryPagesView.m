...
@interface ZWIntroductoryPagesView ()<UIScrollViewDelegate>
/** <#digest#> */
...
@implementation ZWIntroductoryPagesView

+ (instancetype)pagesViewWithFrame:(CGRect)frame images:(NSArray<NSString *> *)images
{
    ZWIntroductoryPagesView *pagesView = [[self alloc] initWithFrame:frame];
