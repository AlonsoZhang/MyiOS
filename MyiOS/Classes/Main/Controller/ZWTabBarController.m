...
- (NSArray *)viewControllers {
    UIViewController *one = [[ZWNavigationController alloc] initWithRootViewController:[[ZWMessageViewController alloc] init]];
    
    UIViewController *two = [[ZWNavigationController alloc] initWithRootViewController:[[ZWNewViewController alloc] init]];
    
    UIViewController *three = [[ZWNavigationController alloc] initWithRootViewController:[[ZWHomeViewController alloc] init]];
    
    UIViewController *four = [[ZWNavigationController alloc] initWithRootViewController:[[ZWMeViewController alloc] init]];
...
/*         ************************* 另外一种写法 这种写法不好添加中间的加号按钮******************************
 ...
 [self setValue:[NSValue valueWithUIOffset:UIOffsetMake(0, -3)] forKeyPath:ZWKeyPath(self, titlePositionAdjustment)];
 [self addTabarItems];
 ...
 {
 ZWNavigationController *one = [[ZWNavigationController alloc] initWithRootViewController:[[ZWHomeViewController alloc] init]];
 
 ZWNavigationController *two = [[ZWNavigationController alloc] initWithRootViewController:[[ZWNewViewController alloc] init]];
 
 ZWNavigationController *three = [[ZWNavigationController alloc] initWithRootViewController:[[ZWMessageViewController alloc] init]];
 
 ZWNavigationController *four = [[ZWNavigationController alloc] initWithRootViewController:[[ZWMeViewController alloc] init]];
