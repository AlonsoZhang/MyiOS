...
//
//
//    [ZWUMengHelper getUserInfoForPlatform:type completion:^(UMSocialUserInfoResponse *result, NSError *error) {
//
//        NSLog(@"result ==== %@", result);
//
//    }];
...
//    ZWRegisterViewController *sms = [[ZWRegisterViewController alloc]init];
...
{
    //[ZWUMengHelper shareTitle:@"NJHu-GitHub" subTitle:@"谢谢使用!欢迎交流!" thumbImage:@"https://avatars2.githubusercontent.com/u/18454795?s=400&u=c8a7cc691e5c3611e9fb49dcf9c83843dd9141a2&v=4" shareURL:@"https://www.jianshu.com"];
    //加入copy的操作
...
- (UIImage *)ZWNavigationBarRightButtonImage:(UIButton *)rightButton navigationBar:(ZWNavigationBar *)navigationBar
{
    ...
    btn.backgroundColor = ZWRGBColor(241, 158, 194);
...
-(void) addMiddleTitleView
{
    ...
    customLab.frame = CGRectMake(self.viewAnima.frame.size.width, customLabY,ZWScreenWidth, 30);
