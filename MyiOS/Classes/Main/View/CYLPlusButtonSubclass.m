...
//#import "ZWPublicViewController.h"
...
- (void)clickPublish {
    ...
    //[viewController presentViewController:[[ZWPublicViewController alloc]init] animated:NO completion:nil];
    ...
    //    CYLTabBarController *tabBarController = [self cyl_tabBarController];
    //    UIViewController *viewController = tabBarController.selectedViewController;
    //    ZWQRCodeViewController *vc = [[ZWQRCodeViewController alloc]init];
